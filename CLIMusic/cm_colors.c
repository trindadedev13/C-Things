...
void cm_colors_init(cm_color_pair background_id) {
  ...
  // Associações de pares de cores
  init_pair(CM_COLOR_PRIMARY_DARK_PAIR, CM_COLOR_PRIMARY_DARK_ID, background_id);
  ...
  init_pair(CM_COLOR_BACKGROUND_PAIR,   COLOR_BLACK,              background_id); // background
}
